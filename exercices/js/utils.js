function trace(s) {
    ...
    var debugV2 = (function () {
		...
		return function (message) {
			if (compteurInterne > valMax) return;

			compteurInterne++;
			if (message == undefined) {
				trace(compteurInterne);
			} else {
				trace(message);
			}
		}
	...
	function html(refOrId, val) {
		// affecte une valeur à l'élément dont la 
		// référence ou l'id est fourni;
		// si val n'est pas fourni,
		// on renvoie son contenu
